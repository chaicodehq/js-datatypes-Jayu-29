...
export function iplAuctionSummary(team, players) {
  // Your code here
  if(typeof team !== "object"  || team === null|| typeof players !== "object" || players === null || typeof team.purse !== "number" || team.purse < 0 || !Array.isArray(players) || players.length === 0){
    return null;
  }
  ...
  const cheapestPlayer = players.reduce((max,current) => {
    return current.price < max.price ? current : max;
  })
